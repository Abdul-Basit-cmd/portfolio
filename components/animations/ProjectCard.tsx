...
export function ProjectCard({
  ...
  useGSAP(
    () => {
      ...
      const sXTo = gsap.quickTo(spotlight.current, "x", { duration: 0.1, ease: "power3.out" });
      const sYTo = gsap.quickTo(spotlight.current, "y", { duration: 0.1, ease: "power3.out" });
  ...
  return (
    ...
    >
      ...
      <div className="md:col-span-5 [direction:ltr]">
        ...
        <h3 className="mt-4 text-3xl font-medium tracking-tight">{project.title}</h3>
